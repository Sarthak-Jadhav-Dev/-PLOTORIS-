    ...
    return (
        <div className="min-h-screen flex">
                ...
                <div className="relative z-10 max-w-md px-8">
                    ...
                    >
                        ...
                        <p className="text-text-secondary text-lg leading-relaxed">
                            Continue your research journey. Your AI assistant is ready and waiting.
                        </p>
                        ...
                        <div className="mt-12 space-y-4">
                            ...
                            >
                                <div className="w-10 h-10 rounded-lg bg-orange-primary/10 flex items-center justify-center">
                                    <Mail size={18} className="text-orange-primary" />
                                </div>
                                <div>
                                    <p className="text-text-primary text-sm font-medium">2.5M+ Papers</p>
                                    <p className="text-text-secondary text-xs">Analyzed and indexed</p>
                                </div>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                            ...
                            >
                                <div className="w-10 h-10 rounded-lg bg-orange-primary/10 flex items-center justify-center">
                                    <Lock size={18} className="text-orange-primary" />
                                </div>
                                <div>
                                    <p className="text-text-primary text-sm font-medium">Enterprise Security</p>
                                    <p className="text-text-secondary text-xs">SOC 2 compliant</p>
                                </div>
                            </motion.div>
                        </div>
                    </motion.div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-background relative">
                {/* Subtle gradient */}
                <div className="absolute top-0 right-0 w-96 h-96 bg-orange-primary/5 rounded-full blur-[200px]" />
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        <button className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-border bg-surface-raised text-text-primary text-sm font-medium hover:border-border-hover hover:bg-surface-overlay transition-all duration-300">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <span className="text-xs text-text-muted uppercase tracking-wider">or continue with email</span>
                        <div className="h-px flex-1 bg-border" />
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleLogin}>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <a href="#" className="text-xs text-orange-primary hover:text-orange-light transition-colors">
                                    Forgot password?
                                </a>
                            </div>
                            <div className="relative">
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                type="checkbox"
                                id="remember"
                                className="w-4 h-4 rounded border-border bg-surface-raised accent-orange-primary"
                            />
