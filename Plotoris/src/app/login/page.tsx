                    ...
                    >
                        ...
                        <div className="mt-12 space-y-4">
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-sm font-medium">2.5M+ Papers</p>
                                    <p className="text-xs text-text-muted">Analyzed and indexed</p>
                                </div>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-text-muted">SOC 2 compliant</p>
                                </div>
                            </motion.div>
                        </div>
                    </motion.div>
