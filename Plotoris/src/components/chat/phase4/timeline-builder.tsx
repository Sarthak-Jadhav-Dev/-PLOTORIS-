...
import { Clock, Plus, Trash2, CheckCircle2, Circle, GripVertical } from "lucide-react";
import { Button } from "@/components/ui/button";

const MONTHS = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];

const defaultTasks = [
  { id: "t1", name: "Participant Recruitment", startMonth: 0, duration: 2, color: "bg-blue-500", done: false },
  { id: "t2", name: "Pilot Testing", startMonth: 1, duration: 1, color: "bg-fuchsia-500", done: false },
  { id: "t3", name: "Data Collection", startMonth: 2, duration: 3, color: "bg-amber-500", done: false },
  { id: "t4", name: "Data Cleaning & Preparation", startMonth: 5, duration: 1, color: "bg-rose-500", done: false },
  { id: "t5", name: "Statistical Analysis", startMonth: 6, duration: 2, color: "bg-indigo-500", done: false },
  { id: "t6", name: "Writing & Review", startMonth: 8, duration: 3, color: "bg-emerald-500", done: false },
];
      ...
      <div className="bg-[#1a1a1a] border border-[#333] p-8 rounded-2xl shadow-xl">
            ...
            {tasks.map((task) => (
              <div key={task.id} className="flex items-center gap-2 group">
                <div className="w-56 shrink-0 flex items-center gap-2">
                  ...
                  <span className="text-sm text-white truncate font-medium">{task.name}</span>
                </div>
        ...
        <div className="mt-8 border-t border-[#333] pt-6 space-y-4">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button onClick={addTask} className="bg-amber-600 hover:bg-amber-700 text-white">
