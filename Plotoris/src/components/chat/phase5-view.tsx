...
export default function PhaseFiveView() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#050505] text-[#d4d4d4] p-4 lg:p-8 font-sans relative">
      ...
      {/* Top Banner */}
      <div className="absolute top-0 left-0 right-0 bg-cyan-500/10 border-b border-cyan-500/20 px-4 py-2 flex items-center justify-center gap-2">
        <DatabaseZap size={14} className="text-cyan-400" />
        <span className="text-xs font-semibold text-cyan-300">
          MARKET GAP ADDRESSED: Data collection tools are completely disconnected from the research workflow. Plotoris unifies them.
        </span>
      </div>
